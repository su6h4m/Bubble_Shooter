//If you are copying this code make sure to follow me on Insta / Github / Facebook 
// The function gets called when the window is fully loaded
window.onload = function() {
    // Get the canvas and context
    var canvas = document.getElementById("viewport");
    var context = canvas.getContext("2d");
    //coded by Shubham Sharma
    ...
    function snapBubble() {
        ...
        // Add the tile to the grid contributed by shu6h4m
        if (addtile) {
    ...
    function checkGameOver() {
        ...
        return false;//script contributed by shu6h4m
    }
    ...
    function findColors() {
        ...
        return foundcolors; //script contributed by shu6h4m
    }
    ...
    function render() {
        ...
        if (gamestate == gamestates.gameover) {
            ...
            context.font = "24px Verdana";
            drawCenterText("Game Over ! Click To Start Again", level.x, level.y + level.height / 2 + 10, level.width);
            drawCenterText("Connect With Me", level.x, level.y + level.height / 2 + 70, level.width);
            drawCenterText("( shu6h4m )", level.x, level.y + level.height / 2 + 100, level.width);
            drawCenterText("↓ ↓ ↓ ↓ ↓ ↓", level.x, level.y + level.height / 2 + 200, level.width);
        }
    }
    ...
    function drawFrame() {
        ...
        context.fillStyle = "ORANGE";
        context.font = "24px Verdana";
        context.fillText("Bubble Shooter by Shubham !", 10, 37);
